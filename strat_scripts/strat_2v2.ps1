...
$StrategyName = "strat.FlagDashStrategy"
...
$botSpecs = @(
    ...
    @{
        ...
        Arguments = @(
            ...
            "--action-tick", "$ActionTickSeconds",
            "--strategy", "$StrategyName",
            "--wait-for-users", "$teamAFollowerUsername,$teamBLeaderUsername,$teamBFollowerUsername",
            "--verbose"
        )
...
Write-Host ""
Write-Host "=== STRAT 2V2 ===" -ForegroundColor Cyan
...
Write-Host "Strategy:      FlagDashStrategy"
